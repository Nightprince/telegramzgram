...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        actionBar.setBackgroundColor(AndroidUtilities.defColor);
            ...
            switch (holder.getItemViewType()) {
                ...
                case 3: {
                    ...
                    if (position == enableAnimationsRow) {
                        ...
                        textCell.setTextAndValueAndCheck(LocaleController.getString("multiforward", R.string.multiforward), LocaleController.getString("DirectShareInfo", R.string.DirectShareInfo), MediaController.getInstance().canDirectShare(), false, true);
                    } else if (position == dumpCallStatsRow) {
