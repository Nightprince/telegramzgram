...
import org.zgram.ui.Components.CheckBoxSquare;
...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin) {
        ...
        mutualImageView.setImageResource(R.drawable.cn);
        ...
        statusTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        if (checkbox == 2) {
            checkBoxBig = new CheckBoxSquare(context,true);
