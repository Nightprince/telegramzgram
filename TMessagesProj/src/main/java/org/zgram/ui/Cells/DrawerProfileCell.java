...
public class DrawerProfileCell extends FrameLayout {
    ...
    private void updateTheme(){
        ...
        int tColor = themePrefs.getInt(("themeColor"), Theme.getColor(Theme.key_actionBarDefault));
        ...
        SharedPreferences plusPreferences = ApplicationLoader.applicationContext.getSharedPreferences("avageramConfig", Activity.MODE_PRIVATE);
