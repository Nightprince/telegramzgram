...
//        Theme.dialogs_superGroupDrawable.setColorFilter(nColor, PorterDuff.Mode.SRC_IN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //   if (this.drawStatus) {
               setDrawableBounds(this.statusBG, this.avatarLeftMargin + AndroidUtilities.dp(36.0f), AndroidUtilities.dp(46.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
       ...
       if (drawStatus && !drawNameBroadcast && !drawNameGroup && !drawNameBot)
       {
           ...
           setDrawableBounds(statusBG, measuredWidth, AndroidUtilities.dp(46.0f),  AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
    ...
    private void setStatusColor() {
        String s = this.user != null ? LocaleController.formatUserStatus(this.user) : BuildConfig.FLAVOR;
        ...
        int l = (this.user == null || this.user.status == null) ? -2 : ConnectionsManager.getInstance().getCurrentTime() - this.user.status.expires;
        if (l > 0 && l < DateTimeConstants.SECONDS_PER_DAY) {
            this.statusBG.setColor(-3355444);
        }
    }
