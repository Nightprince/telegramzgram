...
import org.zgram.ui.Cells.TextCheckBoxCell;
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    if (ProfileNotificationsActivity.this.notificationsEnabled && ProfileNotificationsActivity.this.customEnabled) {
                        AndroidUtilities.getUserPrefs("Notifications", 0).edit().putInt("notify2_" + ProfileNotificationsActivity.this.dialog_id, 0).commit();
                    }
                    ...
                    if (position == soundRow) {
                        ...
                        list.setAdapter(new RecyclerListView.SelectionAdapter() {
                            ...
                            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                                View view = new android.support.v7.widget.AppCompatTextView(context1) {
                                    @Override
                        ...
                        builder.setNegativeButton(LocaleController.getString("SmartNotificationsDisabled", R.string.SmartNotificationsDisabled), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                AndroidUtilities.getUserPrefs("Notifications", 0).edit().putInt("smart_max_count_" + ProfileNotificationsActivity.this.dialog_id, 0).commit();
                        ...
                        AndroidUtilities.getUserPrefs("Notifications", 0).edit().putInt("popup_" + ProfileNotificationsActivity.this.dialog_id, 1).commit();
                        ...
                        AndroidUtilities.getUserPrefs("Notifications", 0).edit().putInt("popup_" + ProfileNotificationsActivity.this.dialog_id, 2).commit();
                        ((RadioCell) view).setChecked(true, true);
