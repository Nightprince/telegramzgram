...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        doneButtonBadgeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        doneButtonTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
