...
public class Switch extends CompoundButton {
    ...
    public void setChecked(boolean checked) {
        ...
        if(getTag() == null){
            ...
            int defColor = preferences.getInt(("themeColor"), Theme.getColor(Theme.key_actionBarDefault));
            ...
            int darkColor = AndroidUtilities.getIntAlphaColor(("themeColor"), defColor, 0.5f);
