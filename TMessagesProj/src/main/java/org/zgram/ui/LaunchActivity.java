...
import org.zgram.messenger.MainActivity;
...
import org.zgram.messenger.NativeCrashManager;
...
import org.zgram.messenger.camera.CameraController;
...
import org.zgram.ui.Adapters.DrawerLayoutAdapter;
import org.zgram.ui.ActionBar.ActionBarLayout;
import org.zgram.ui.ActionBar.BaseFragment;
import org.zgram.ui.ActionBar.DrawerLayoutContainer;
import org.zgram.ui.Cells.LanguageCell;
import org.zgram.ui.Components.EmbedBottomSheet;
import org.zgram.ui.Components.JoinGroupAlert;
import org.zgram.ui.Components.LayoutHelper;
import org.zgram.ui.Components.PasscodeView;
...
import org.zgram.ui.Components.ThemeEditorView;
...
import org.zgram.tgnet.AllMediaActivity;

import edit.DeleteBySelectContacts;
import edit.FindUsersActivity;

import edit.acc.AccountManagerActivity;
import edit.acc.AccountsController;
import edit.category.categoryManagement;
import edit.dlmanager.DownloadManagerActivity;
import edit.fonts.FontsSelect;
import edit.monshi.secretory;
import edit.settings.GelasSettings;
import edit.spambot;
import edit.users.ui.SpecificContacts;
import edit.users.ui.userChanges;
...
public class LaunchActivity extends Activity implements ActionBarLayout.ActionBarLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    private static RecyclerListView sideMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UserConfig.isClientActivated() && AccountsController.getInstance().isNewActiveAccount() && AccountsController.getInstance().activeAccount != null) {
            AccountsController.getInstance().saveLogin(UserConfig.getCurrentUser().phone, true);
        }
        ...
        if (!UserConfig.isClientActivated() && AccountsController.getInstance().listAppAccounts.size() == 1 && AccountsController.getInstance().activeAccountId == 0) {
            ...
            if (intent != null && intent.getAction() != null && ("android.intent.action.SEND".equals(intent.getAction()) || intent.getAction().equals("android.intent.action.SEND_MULTIPLE"))) {
                ...
                finish();
                return;
            } else if (!(intent == null || intent.getBooleanExtra("fromIntro", false) || !AndroidUtilities.getUserPrefs("logininfo2", 0).getAll().isEmpty())) {
        ...
        sideMenu.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                if (position == 0) {
                    ...
                    Toast.makeText(getApplicationContext(),"Mohammad",Toast.LENGTH_SHORT).show();
                   ...
                   presentFragment(new userChanges());
                    ...
                    presentFragment(new GelasSettings());
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 25) {
                   ...
                   //
                    //presentFragment(new UserManageActivity());
                    drawerLayoutContainer.closeDrawer(false);
                }
                else if (id == 28) {
                    presentFragment(new AccountManagerActivity());
                    drawerLayoutContainer.closeDrawer(false);
                }
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                        ...
                        if (data != null) {
                            ...
                            if (scheme != null) {
                                if ((scheme.equals("http") || scheme.equals("https"))) {
                                    ...
                                    if (host.equals("zgram.me") || host.equals("t.me") || host.equals("zgram.dog") || host.equals("telesco.pe")) {
                                    ...
                                    if (url.startsWith("tg:resolve") || url.startsWith("tg://resolve")) {
                                        url = url.replace("tg:resolve", "tg://zgram.org").replace("tg://resolve", "tg://zgram.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:join", "tg://zgram.org").replace("tg://join", "tg://zgram.org");
                                        data = Uri.parse(url);
                                        group = data.getQueryParameter("invite");
                                    } else if (url.startsWith("tg:addstickers") || url.startsWith("tg://addstickers")) {
                                        url = url.replace("tg:addstickers", "tg://zgram.org").replace("tg://addstickers", "tg://zgram.org");
                                        data = Uri.parse(url);
                                        ...
                                        url = url.replace("tg:msg", "tg://zgram.org").replace("tg://msg", "tg://zgram.org").replace("tg://share", "tg://zgram.org").replace("tg:share", "tg://zgram.org");
                                        data = Uri.parse(url);
                                        message = data.getQueryParameter("url");
                                        if (message == null) {
                                            message = "";
                    ...
                    } else if (intent.getAction().equals("org.zgram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
    ...
    private void showLanguageAlertInternal(LocaleController.LocaleInfo systemInfo, LocaleController.LocaleInfo englishInfo, String systemLang) {
        try {
            ...
            final String englishName = getStringForLanguageAlert(systemLocaleStrings, "Persian", R.string.English);
