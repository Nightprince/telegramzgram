    ...
    private void processFoundUser(TLRPC.User user) {
        ...
        if (user != null && user.bot && user.bot_inline_placeholder != null) {
            ...
            if (this.foundContextBot.bot_inline_geo) {
                if (AndroidUtilities.getUserPrefs("Notifications", 0).getBoolean("inlinegeo_" + this.foundContextBot.id, false) || this.parentFragment == null || this.parentFragment.getParentActivity() == null) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (foundContextBotFinal != null) {
                                AndroidUtilities.getUserPrefs("Notifications", 0).edit().putBoolean("inlinegeo_" + foundContextBotFinal.id, true).commit();
