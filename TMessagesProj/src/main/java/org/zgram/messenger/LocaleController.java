...
import org.zgram.messenger.time.FastDateFormat;
...
import edit.shamsi.ShamsiCalendar;
import edit.shamsi.ShamsiDate;
...
//                currentInfo = languagesDict.get(systemDefaultLocale.getLanguage());
    ...
    public static String formatDateChat(long j) {
        try {
            ...
            if (!language.toLowerCase().equals("fa") && !language.toLowerCase().equals("fa") ) {
