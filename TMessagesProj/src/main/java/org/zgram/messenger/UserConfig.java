    ...
    public static void saveConfig(boolean withFile, File oldFile) {
        synchronized (sync) {
            try {
                ...
                SharedPreferences.Editor editor = AndroidUtilities.getUserPrefs("userconfing", 0).edit();
            ...
            if (configFile.exists()) {
                try {
                    ...
                    if (ver == 1) {
                        ...
                        SharedPreferences preferences = AndroidUtilities.getUserPrefs("userconfing", 0);
...
//                dialogsLoadOffsetAccess = -1;
                ...
                if (!notificationsConverted) {
                    try {
                        ...
                        preferences = AndroidUtilities.getUserPrefs("Notifications", 0);
