...
import org.zgram.SQLite.SQLiteDatabase;
    ...
    public void openDatabase(boolean first) {
        ...
        try {
            ...
            if (createTable) {
                ...
                database.executeFast("CREATE TABLE turbo_idm(mid INTEGER PRIMARY KEY, uid INTEGER, date INTEGER, data BLOB)").stepThis().dispose();
            ...
            public void run() {
                try {
                   ...
                   // SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("Notifications", Context.MODE_PRIVATE);
                    Map<String, ?> values = AndroidUtilities.getUserPrefs("Notifications", 0).getAll();
