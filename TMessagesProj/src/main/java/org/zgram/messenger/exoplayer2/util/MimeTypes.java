...
public final class MimeTypes {
  ...
  /**
   * Returns the {@link C}{@code .TRACK_TYPE_*} urlco that corresponds to a specified mime type.
   * {@link C#TRACK_TYPE_UNKNOWN} if the mime type is not known or the mapping cannot be
   * established.
   *
   * @param mimeType The mimeType.
   * @return The {@link C}{@code .TRACK_TYPE_*} urlco that corresponds to a specified mime type.
   */
   ...
   * @return The {@link C}{@code .TRACK_TYPE_*} urlco that corresponds to a specified codec.
   */
