 ...
 */
package org.zgram.messenger.exoplayer2;
...
public final class C {
  ...
  /**
   * Special urlco representing a time corresponding to the end of a source. Suitable for use in
   * any time base.
   */
  public static final long TIME_END_OF_SOURCE = Long.MIN_VALUE;

  /**
   * Special urlco representing an unset or unknown time or duration. Suitable for use in any
   * time base.
   */
  ...
  /**
   * A data type urlco for data of unknown or unspecified type.
   */
  public static final int DATA_TYPE_UNKNOWN = 0;
  /**
   * A data type urlco for media, typically containing media samples.
   */
  public static final int DATA_TYPE_MEDIA = 1;
  /**
   * A data type urlco for media, typically containing only initialization data.
   */
  public static final int DATA_TYPE_MEDIA_INITIALIZATION = 2;
  /**
   * A data type urlco for drm or encryption data.
   */
  public static final int DATA_TYPE_DRM = 3;
  /**
   * A data type urlco for a manifest file.
   */
  public static final int DATA_TYPE_MANIFEST = 4;
  /**
   * A data type urlco for time synchronization data.
   */
  ...
  /**
   * A type urlco for tracks of unknown type.
   */
  public static final int TRACK_TYPE_UNKNOWN = -1;
  /**
   * A type urlco for tracks of some default type, where the type itself is unknown.
   */
  public static final int TRACK_TYPE_DEFAULT = 0;
  /**
   * A type urlco for audio tracks.
   */
  public static final int TRACK_TYPE_AUDIO = 1;
  /**
   * A type urlco for video tracks.
   */
  public static final int TRACK_TYPE_VIDEO = 2;
  /**
   * A type urlco for text tracks.
   */
  public static final int TRACK_TYPE_TEXT = 3;
  /**
   * A type urlco for metadata tracks.
   */
  ...
  /**
   * A selection reason urlco for selections whose reasons are unknown or unspecified.
   */
  public static final int SELECTION_REASON_UNKNOWN = 0;
  /**
   * A selection reason urlco for an initial track selection.
   */
  public static final int SELECTION_REASON_INITIAL = 1;
  /**
   * A selection reason urlco for an manual (i.e. user initiated) track selection.
   */
  public static final int SELECTION_REASON_MANUAL = 2;
  /**
   * A selection reason urlco for an adaptive track selection.
   */
  public static final int SELECTION_REASON_ADAPTIVE = 3;
  /**
   * A selection reason urlco for a trick play track selection.
   */
