...
import org.zgram.messenger.exoplayer2.ParserException;
import org.zgram.messenger.exoplayer2.Timeline;
import org.zgram.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
import org.zgram.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import org.zgram.messenger.exoplayer2.source.MediaPeriod;
...
import org.zgram.messenger.exoplayer2.source.dash.manifest.DashManifestParser;
import org.zgram.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
import org.zgram.messenger.exoplayer2.upstream.Allocator;
import org.zgram.messenger.exoplayer2.upstream.DataSource;
import org.zgram.messenger.exoplayer2.upstream.Loader;
import org.zgram.messenger.exoplayer2.upstream.LoaderErrorThrower;
import org.zgram.messenger.exoplayer2.upstream.ParsingLoadable;
import org.zgram.messenger.exoplayer2.util.Assertions;
...
public final class DashMediaSource implements MediaSource {
  ...
  /**
   * A urlco indicating that the presentation delay for live streams should be set to
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            org.zgram.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      org.zgram.messenger.exoplayer2.source.dash.manifest.Period period =
