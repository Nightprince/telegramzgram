...
import org.zgram.messenger.AnimationCompat.AnimatorSetProxy;
...
import org.zgram.messenger.query.AllSharedMediaQuery;
...
import org.zgram.ui.ActionBar.ActionBarPopupWindow;
...
import org.zgram.ui.Adapters.BaseFragmentAdapter;
import org.zgram.ui.Adapters.BaseSectionsAdapter;
import org.zgram.ui.Cells.GreySectionCell;
import org.zgram.ui.Cells.LoadingCell;
import org.zgram.ui.Cells.SharedDocumentCell;
import org.zgram.ui.Cells.SharedLinkCell;
import org.zgram.ui.Cells.SharedMediaSectionCell;
import org.zgram.ui.Cells.SharedPhotoVideoCell;
...
import org.zgram.ui.Components.SectionsListView;
import org.zgram.ui.Components.WebFrameLayout;
...
public class AllMediaActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
       ...
       // actionBar.setBackgroundColor(def);
        ...
        dropDown.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        if (UserConfig.isClientActivated() && firstime) {
            final TapTargetSequence sequence = new TapTargetSequence(getParentActivity())
                    .targets(
                            ...
                            TapTarget.forView(dropDownContainer,  LocaleController.getString("Wellcome",R.string.wellcome), LocaleController.getString("drawer",R.string.drawer))
                                    .dimColor(android.R.color.black)
                                    .outerCircleColorInt(0xff75a048)
