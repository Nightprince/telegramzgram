...
public class TLRPC {
	...
	public static class Dialog extends TLObject {
		...
		public static Dialog TLdeserialize(AbstractSerializedData stream, int constructor, boolean exception) {
			...
			switch(constructor) {
				case 0x5b8496b2:
					result = new TL_updates_difference.TL_dialogChannel();
					break;
				case 0xc1dd804a:
					result = new TL_updates_difference.TL_dialog();
					break;
			}
			if (result == null && exception) {
	...
	public static class TL_dialog extends TLObject {
		public static int constructor = 0x66ffba14;
			...
			public boolean isHidden = false ; // custom
			public boolean isCat = false ; // custom
			public int HiddenCode = 0 ; // custom
			public int catCode = 0 ; // custom
