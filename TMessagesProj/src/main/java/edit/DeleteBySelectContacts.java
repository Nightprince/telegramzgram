...
import org.zgram.ui.Components.ChipSpan;
            ...
            public void run() {
               selectedContacts.clear();
                ...
                if (searching &&searchWas) {
                    ...
                    for (i = 0; i <listViewAdapter.getSectionCount(); i ++) {
                        for (int i2 = 0; i2 <listViewAdapter.getCountForSection(i); i2 ++) {
                            user = (TLRPC.User)listViewAdapter.getItem(i, i2);
                            if (user != null) {
                               selectedContacts.put(Integer.valueOf(user.id), null);
                            }
                        }
