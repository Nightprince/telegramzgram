...
import org.zgram.ui.Cells.BaseCell;
import org.zgram.ui.Components.AvatarDrawable;
import org.zgram.ui.ImageListActivity;

import java.util.ArrayList;

import static org.zgram.ui.ActionBar.Theme.broadcastDrawable;
...
//    private boolean dialogMuted;
    ...
    public CustomDialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            namePaint.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
            ...
            groupPaint.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));

            nameEncryptedPaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            nameEncryptedPaint.setTextSize(AndroidUtilities.dp(9));
            nameEncryptedPaint.setColor(0xff00a60e);
            nameEncryptedPaint.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
            ...
            nameUnknownPaint.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
...
//
            ...
            countPaint.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
...
//        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(View.MeasureSpec.getSize(widthMeasureSpec), AndroidUtilities.dp(72) + (useSeparator ? 1 : 0));
    }
