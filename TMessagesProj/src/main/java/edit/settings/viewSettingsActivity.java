...
//                    DialogsActivity.refreshToolbarItems();
                    ...
                    SharedPreferences preferences = AndroidUtilities.getUserPrefs("mainconfig", 0);
                    boolean scr = preferences.getBoolean("dontTik", true);
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putBoolean("dontTik", !scr);
                    editor.apply();
                    if (view instanceof TextCheckCell) {
                        ((TextCheckCell) view).setChecked(!scr);
                    }
            ...
            if (type == 0) {
                ...
                if (i == showAndroidEmojiRow) {
                   ...
                   // textCell.setTextAndCheck(LocaleController.getString("hideGhostMode", R.string.hideGhostMode), preferences.getBoolean("hideGhostModeRow", false), true);
                    ...
                    //textCell.setTextAndCheck(LocaleController.getString("dont_Tik", R.string.dont_Tik), mainPreferences.getBoolean("dontTik", true), true);
                } else if (i == hideLockRow) {
