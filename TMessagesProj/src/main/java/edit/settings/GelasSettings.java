...
import org.zgram.ui.Cells.TextInfoCell;
...
import org.zgram.ui.DocumentSelectActivity;
import org.zgram.ui.PhotoViewer;
import org.zgram.ui.SessionsActivity;
import org.zgram.ui.TwoStepVerificationActivity;
...
public class GelasSettings extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
...
//        ghostModeRow = rowCount++;
    ...
    public View createView(Context context) {
        ...
        avatarImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user != null && user.photo != null && user.photo.photo_big != null) {
                    ...
                    PhotoViewer.getInstance().openPhoto(user.photo.photo_big, GelasSettings.this);
                }
            }
        });
        ...
        nameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == tabsRow ||
                    i == forwardSettingsRow ||
                      i == viewSettingRow || i== reportHelp || i == sessionsRow || i == passwordRow ||
        ...
        public int getItemViewType(int i) {
            ...
            if (i == settingsSectionRow || i == PrivacySection || i == plusSettingsSectionRow ) {
                return 1;
                    ...
                    i == forwardSettingsRow  ||  i == viewSettingRow ||
                    i == reportHelp ||  i == sessionsRow || i == passwordRow  ) {
                return 2;
