...
public class TabSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                 ...
                 if (i == dialogsHideTabsCheckRow) {
                    ...
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putBoolean("ShowTabsInBottomRow", !disable);
                    editor.apply();
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.refreshTabs, 55);
                    if (view instanceof TextCheckCell) {
                        ((TextCheckCell) view).setChecked(!disable);
                    }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return   i == dialogsTabsRow ||
                   i == dialogsHideTabsCheckRow ||i == ShowTabsInBottomRow ||
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
               ...
               if (i == dialogsHideTabsCheckRow) {
                    ...
                    textCell.setTextAndCheck(LocaleController.getString("ShowTabsInBottom", R.string.ShowTabsInBottom), preferences.getBoolean("ShowTabsInBottomRow", false), true);
                } else if (i == dialogsInfiniteTabsSwipe) {
        ...
        public int getItemViewType(int i) {
            ...
            if ( i == dialogsSectionRow ) {
                return 1;
            } else if ( i == dialogsHideTabsCheckRow || i == ShowTabsInBottomRow || i == dialogsInfiniteTabsSwipe ||
