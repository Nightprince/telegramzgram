...
import org.zgram.ui.ArticleViewer;
import org.zgram.ui.Cells.BotHelpCell;
import org.zgram.ui.Cells.BotHelpCell.BotHelpCellDelegate;
import org.zgram.ui.Cells.ChatActionCell;
import org.zgram.ui.Cells.ChatActionCell.ChatActionCellDelegate;
...
import org.zgram.ui.Components.ContextProgressView;
...
import org.zgram.ui.Components.RecyclerListView.OnInterceptTouchListener;
import org.zgram.ui.Components.RecyclerListView.OnItemClickListener;
import org.zgram.ui.Components.RecyclerListView.OnItemLongClickListener;
...
import org.zgram.ui.DialogsActivity.DialogsActivityDelegate;
import org.zgram.ui.LocationActivity;
import org.zgram.ui.PhotoViewer;
import org.zgram.ui.PhotoViewer.PhotoViewerProvider;
import org.zgram.ui.PhotoViewer.PlaceProviderObject;
import org.zgram.ui.ProfileActivity;
import org.zgram.ui.StickerPreviewViewer;
                ...
                chatMessageCell.setDelegate(new ChatMessageCellDelegate() {
                    ...
                    public void didPressedInstantButton(ChatMessageCell cell) {
                        ...
                        if (messageObject.messageOwner.media != null && messageObject.messageOwner.media.webpage != null && messageObject.messageOwner.media.webpage.cached_page != null) {
                            ArticleViewer.getInstance().setParentActivity(getParentActivity(),null);
                            ...
                            if (message.type == 13) {
                                ...
                                try {
                                    ...
                                    if (VERSION.SDK_INT >= 24) {
                                        intent.setFlags(1);
                                        intent.setDataAndType(FileProvider.getUriForFile(getParentActivity(), "messenger.ongram.provider", f), MimeTypes.VIDEO_MP4);
                                    } else {
...
//                    holder.itemView.setProgressVisible(loadsCount > 1);
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                ...
                if (id == -1) {
                    ...
                    presentFragment(new DownloadSettingsActivity(),false);
                } else if (id == 10) {
                    String str = "";
                    int previousUid = 0;
                    for ( a = 1; a >= 0; a--) {
        ...
        this.selectedMessagesCountTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        this.actionModeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        actionModeViews.add(actionMode.addItem(copy, R.drawable.ic_ab_copy, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
        ...
        actionModeViews.add(actionMode.addItem(forward, R.drawable.ic_ab_forward, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
        actionModeViews.add(actionMode.addItem(delete, R.drawable.ic_ab_delete, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
        ...
        this.alertNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        this.replyNameTextView.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
        ...
        this.bottomOverlayText.setTypeface(AndroidUtilities.getTypeface("fonts/iransans.ttf"));
    ...
    public void sendMedia(MediaController.PhotoEntry photoEntry, boolean mutedVideo) {
        if (photoEntry.isVideo) {
            ...
            SendMessagesHelper.prepareSendingVideo(photoEntry.path, size, 0, 0, 0, videoEditedInfo, this.dialog_id, this.replyingMessageObject, photoEntry.caption != null ? photoEntry.caption.toString() : null,0);
        } else if (photoEntry.imagePath != null) {
            SendMessagesHelper.prepareSendingPhoto(photoEntry.imagePath, null, this.dialog_id, this.replyingMessageObject, photoEntry.caption, photoEntry.stickers, null,0);
            DraftQuery.cleanDraft(this.dialog_id, true);
        } else if (photoEntry.path != null) {
            SendMessagesHelper.prepareSendingPhoto(photoEntry.path, null, this.dialog_id, this.replyingMessageObject, photoEntry.caption, photoEntry.stickers, null,0);
            DraftQuery.cleanDraft(this.dialog_id, true);
        }
    }
    ...
    private void loadFile(TLObject attach) {
        if (attach instanceof  TLRPC.PhotoSize) {
            FileLoader.getInstance().loadFile(( TLRPC.PhotoSize) attach, null, 0);
        } else if (attach instanceof TLRPC.Document) {
            FileLoader.getInstance().loadFile((TLRPC.Document) attach, true, 0);
        }
    }
