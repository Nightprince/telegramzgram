...
import org.zgram.messenger.AnimatorListenerAdapterProxy;
    ...
    private void checkPlayer(boolean create) {
        ...
        if (messageObject == null || messageObject.getId() == 0/* || !messageObject.isMusic()*/) {
            ...
            if (lastMessageObject != messageObject) {
                ...
                TypefaceSpan span = new TypefaceSpan(AndroidUtilities.getTypeface("fonts/iransans.ttf"), 0, Theme.INAPP_PLAYER_PERFORMER_TEXT_COLOR);
